...
export const availablePermissions = {
  ...
  Leave: [{
      key: 'leave:request:view',
      label: 'View All Leaves'
    },
    {
      key: 'leave:request:view_own',
  ...
  LeaveType: [{
    ...
    {
      key: 'leave:type:delete',
      label: 'Delete Leave Types'
    },
  ],
  LeaveBalance: [{
      key: 'leave:balance:view',
      label: 'View All Leave Balances'
    },
    {
      key: 'leave:balance:view_own',
      label: 'View Own Leave Balances'
    },
    {
      key: 'leave:balance:edit',
      label: 'Edit Leave Balances'
    },
    {
      key: 'leave:balance:allocate',
      label: 'Allocate Leave Balances'
    },
  ],
  Holiday: [{
      key: 'holiday:view',
  ...
  Project: [{
      key: 'project:dashboard:view',
      label: 'Project Super Dashboard'
    },
    {
  ...
  TaskSession: [{
      key: 'task-session:view',
      label: 'View Active Task Session'
    },
    {
      key: 'task-session:time:view',
      label: 'View Active Session Time'
    },
    {
      key: 'task-session:status:create',
      label: 'Start Task Session'
    },
    {
      key: 'task-session:status:pause',
      label: 'Pause Task Session'
    },
    {
      key: 'task-session:status:complete',
      label: 'Complete Task Session'
    },
  ],
  Permission: [{
      key: 'admin:permission:view',
