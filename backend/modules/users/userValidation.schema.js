...
export const userUpdateSchema=z.object({
    ...
    role:z.enum(["superadmin","admin","employee"],"role must be superadmin,admin or employee").optional()
})
...
export const createUserSchema=z.object({
    ...
    role:z.enum(["superadmin","admin","employee"],"role must be superadmin,admin or employee")                                                                                                                                                                                                                                                
})